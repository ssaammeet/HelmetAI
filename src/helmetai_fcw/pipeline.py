"""Runtime composition of tracking, FCW assessment and alert hold behaviour."""
...
class ForwardCollisionPipeline:
    """One-call interface from a perception observation to an FCW assessment."""

    def __init__(
        self,
        config: ForwardCollisionConfig | None = None,
        filter_: AlphaBetaTrackFilter | None = None,
        alert_hold_s: float = 0.45,
    ) -> None:
        self.engine = ForwardCollisionRiskEngine(config)
    ...
    def process(self, observation: ObservedTarget) -> RiskAssessment:
        ...
        if (
            ...
            return RiskAssessment(
                ...
                reasons=assessment.reasons + ("alert_hold",),
